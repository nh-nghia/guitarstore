 ...
 */
@WebFilter(filterName = "/Authentication", urlPatterns = { "/administration", "/deleteGuitar", "/deleteOrder",
		"/deleteUserOrder", "/guitarDetail", "/insertGuitar", "/order", "/updateGuitar", "/userOrder" })
